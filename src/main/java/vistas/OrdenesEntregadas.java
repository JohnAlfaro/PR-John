...
public final class OrdenesEntregadas extends javax.swing.JInternalFrame {
    ...
    public OrdenesEntregadas() throws IOException, InterruptedException {
        initComponents();
        listar();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Lista de Ordenes Entregadas");
    ...
    private void btnFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalizarActionPerformed
        ...
        try {
            ...
            Logger.getLogger(OrdenesEntregadas.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    void listar() throws IOException, InterruptedException {
        ...
        while (cont < ordenesJS.length()) {
            ...
            if (ordenJS.getString("state").equals("complete")) {
