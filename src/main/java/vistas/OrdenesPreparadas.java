...
public final class OrdenesPreparadas extends javax.swing.JInternalFrame {
    ...
    public OrdenesPreparadas() throws IOException, InterruptedException {
        initComponents();
        listar();
    }
    ...
    private void btnFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalizarActionPerformed
        ...
        try {
            ...
            Logger.getLogger(OrdenesPreparadas.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    void listar() throws IOException, InterruptedException {
        ...
        while (cont < ordenesJS.length()) {
            ...
            if (ordenJS.getString("state").equals("prepared")) {
