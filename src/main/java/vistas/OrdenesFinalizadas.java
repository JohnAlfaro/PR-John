...
public final class OrdenesFinalizadas extends javax.swing.JInternalFrame {
    ...
    public OrdenesFinalizadas() throws IOException, InterruptedException {
        initComponents();
        listar();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Lista de Ordenes Finalizadas");
        ...
        btnEnCola.setText("EN COLA");
        btnEnCola.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEnColaActionPerformed(evt);
            }
        });
    ...
    private void btnPrepararActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrepararActionPerformed
        ...
        try {
            ...
            Logger.getLogger(OrdenesFinalizadas.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    void listar() throws IOException, InterruptedException {
        ...
        while (cont < ordenesJS.length()) {
            ...
            if (ordenJS.getString("state").equals("finished")) {
